...
BOARD: List[Tile] = [
    ...
    Tile("GO", "START", {}),                                         # 0
    prop("Property 1",   60,  "LC_EASY", "BROWN",      "LC"),        # 1
    Tile("Community Chest", "COMMUNITY", {}),                         # 2
    prop("Property 2",   60,  "LC_EASY", "BROWN",      "BH"),        # 3
    # Income Tax -> third BROWN property
    prop("Property 2A",  70,  "LC_EASY", "BROWN",      "SD"),        # 4
    # Railroads/utilities unchanged
    prop("Railroad 1",  200,  "LC_MED",  "RR",         ""),          # 5
    prop("Property 3",  100,  "LC_EASY", "LIGHT_BLUE", "LC"),        # 6
    Tile("Chance", "CHANCE", {}),                                     # 7
    prop("Property 4",  100,  "LC_MED",  "LIGHT_BLUE", "BH"),        # 8
    prop("Property 5",  120,  "LC_MED",  "LIGHT_BLUE", "SD"),        # 9  -> Jail corner next
    ...
    prop("Property 9",  180,  "LC_MED",  "ORANGE",     "LC"),        # 16
    Tile("Community Chest", "COMMUNITY", {}),                         # 17
    prop("Property 10", 180,  "LC_MED",  "ORANGE",     "BH"),        # 18
    prop("Property 11", 200,  "LC_HARD", "ORANGE",     "SD"),        # 19 -> Free Parking corner

    # Top row, left to right
    Tile("Free Parking", "FREE_PARKING", {}),                         # 20
    prop("Property 12", 220,  "LC_MED",  "RED",        "LC"),        # 21
    Tile("Chance", "CHANCE", {}),                                     # 22
    prop("Property 13", 220,  "LC_HARD", "RED",        "BH"),        # 23
    prop("Property 14", 240,  "LC_HARD", "RED",        "SD"),        # 24
    ...
    prop("Property 18", 300,  "SYS_DESIGN", "GREEN",   "LC"),        # 31
    prop("Property 19", 300,  "SYS_DESIGN", "GREEN",   "BH"),        # 32
    ...
    prop("Property 21", 350,  "SYS_DESIGN", "DARK_BLUE","LC"),       # 37
    # Luxury Tax -> third DARK_BLUE property
    prop("Property 21A", 380, "SYS_DESIGN", "DARK_BLUE","BH"),       # 38
    prop("Property 22", 400,  "BEHAVIORAL","DARK_BLUE","SD"),        # 39 back to GO next
]
